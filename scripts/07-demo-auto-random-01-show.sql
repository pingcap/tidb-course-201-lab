...
INSERT INTO test.auto_random_t1 (name) VALUES
    ('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),
    ('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),
    ('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),
    ('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),('A'),
...
INSERT INTO test.auto_random_t1 SELECT null, name FROM test.auto_random_t1;
INSERT INTO test.auto_random_t1 SELECT null, name FROM test.auto_random_t1;
INSERT INTO test.auto_random_t1 SELECT null, name FROM test.auto_random_t1;
INSERT INTO test.auto_random_t1 SELECT null, name FROM test.auto_random_t1;
INSERT INTO test.auto_random_t1 SELECT null, name FROM test.auto_random_t1;
...
/* Query 3: Count the rows group by using the two leading digits of ID column */
SELECT SUBSTR(CAST(id as CHAR),1,1) as id_prefix, COUNT(*) as approx_rows_in_shard
