...
# Run ./09-demo-jdbc-connection-01-show.sh
...
javac -cp .:misc/mysql-connector-java-5.1.36-bin.jar DemoJdbcConnection.java
sleep 1
java -cp .:misc/mysql-connector-java-5.1.36-bin.jar DemoJdbcConnection
