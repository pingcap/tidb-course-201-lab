...
echo ssh -A ${HOST_PD2_PRIVATE_IP} > ./ssh-to-db2.sh
echo ssh -A ${HOST_PD3_PRIVATE_IP} > ./ssh-to-monitor.sh
echo ssh -A ${HOST_PD1_PRIVATE_IP} > ./ssh-to-kv1.sh
echo ssh -A ${HOST_PD2_PRIVATE_IP} > ./ssh-to-kv2.sh
echo ssh -A ${HOST_PD3_PRIVATE_IP} > ./ssh-to-kv3.sh
