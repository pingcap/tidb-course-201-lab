...
aws s3 cp key.pem s3://${BUCKET}/${TRAINER}/${USER}/ --region ${REGION_CODE}
aws s3 cp cert.pem s3://${BUCKET}/${TRAINER}/${USER}/ --region ${REGION_CODE}
aws s3 cp tiproxy.toml s3://${BUCKET}/${TRAINER}/${USER}/ --region ${REGION_CODE}
