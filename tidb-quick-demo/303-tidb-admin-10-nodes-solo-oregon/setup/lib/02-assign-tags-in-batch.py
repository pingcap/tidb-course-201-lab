...
def _get_tiflash_instance_ids(
    ...
    return _get_node_instance_ids(session, trainer_name, student_count, "tiflash", 1)
...
def _assign_tiflash_to_students(session: boto3.Session, instance_ids: list):
    _assign_nodes_to_students(session, instance_ids, "tiflash", 1)
...
if __name__ == "__main__":
    ...
    tiflash_instance_ids = _get_tiflash_instance_ids(session, trainer_name, int(student_count))
    ...
    _assign_tiflash_to_students(session, tiflash_instance_ids)
