...
def _run_tiflash_nodes(session: boto3.Session, trainer_name: str, student_count: int):
    _run_nodes(session, trainer_name, student_count, "TiFlash", 1, 1, 1)
...
if __name__ == "__main__":
    ...
    _run_tiflash_nodes(session, trainer_name, student_count)
